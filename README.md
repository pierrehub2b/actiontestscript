...
```
Java files will be generated into project folder *target/generated* from scripts found in *src/main/ats* folder, and java files in *src/main/java* folder will be copied in the *target/generated* folder.
