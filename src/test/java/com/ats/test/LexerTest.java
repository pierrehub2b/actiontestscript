...
public class LexerTest {	
	...
	public void createActionTest() throws IOException {
		...
		for (int i = 0; i <= 1; i++) {
			...
			expectedScript.addAction(new ActionMouseScroll(expectedScript, "300", true, new ArrayList<>(), new ArrayList<>()), i == 0);
			expectedScript.addAction(new ActionMouseScroll(expectedScript, "0", true, new ArrayList<>(), new ArrayList<>(Arrays.asList("A [text = Graphical user interface testing]"))), i == 0);
			...
			expectedScript.addAction(new ActionProperty(expectedScript, true, new ArrayList<>(), "text", new Variable("propertyVar",new CalculatedValue(script, "")), new ArrayList<>(Arrays.asList("INPUT [name = q]"))), i == 0);
			...
			expectedScript.addAction(new ActionSelect(expectedScript, "index = 0", true, new ArrayList<>(), new ArrayList<>(Arrays.asList("div"))), i == 0);
			expectedScript.addAction(new ActionScripting(expectedScript, true, new ArrayList<>(), "alert(\"test\")", null, new ArrayList<>()), i == 0);
